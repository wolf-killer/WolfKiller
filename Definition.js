...
var allActorRule = {
	...
	"Seer": "每夜可以查驗一位存活玩家。",
	"Witch": "擁有一瓶解藥和一瓶毒藥。",
	"Knight": "白天發言階段可以翻牌選擇與一名玩家決鬥。<br/>如對方是狼人則對方即時出局，並直接進入夜晚；</br>如對方是好人則騎士以死謝罪，繼續白天流程。",
	"Hunter": "淘汰時可以開槍帶走一位玩家。",
	"Guard": "每晚可以守護一名玩家免受狼人殺害，但不能連續兩晚守護同一人。",
	"Bear": "每晚，熊左右兩位玩家當中若有至少有一個狼人，則會於隔天早上咆哮。",
	"Idiot": "若白天放逐公投中被投出，可翻開角色牌以免疫該次淘汰，但在之後的公投中失去投票權利。",
	"Villager": "沒有特殊技能，黑夜階段全程閉眼。"
};
var victoryCondition = {
	"title": "勝利條件解說",
	"content": "屠邊：所有神職<b>或</b>所有平民死亡。<br/>屠城：所有神職<b>及</b>所有平民死亡。<br/>好人勝利：所有狼人死亡。"
};
